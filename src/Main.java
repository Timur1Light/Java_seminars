...
критерии) фильтрации и выведет ноутбуки, отвечающие фильтру. Критерии фильтрации можно хранить в Map.
Например:
...
public class Main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop(8, 512, "macOS", "Silver"));
        laptops.add(new Laptop(8, 1024, "Ubuntu", "Gray"));
        laptops.add(new Laptop(16, 256, "Windows 10", "Black"));
        laptops.add(new Laptop(16, 512, "macOS", "Silver"));
        laptops.add(new Laptop(16, 1024, "Ubuntu", "Gray"));
        laptops.add(new Laptop(32, 256, "Windows 10", "Black"));
        laptops.add(new Laptop(32, 512, "macOS", "Silver"));
        laptops.add(new Laptop(32, 1024, "Ubuntu", "Gray"));
